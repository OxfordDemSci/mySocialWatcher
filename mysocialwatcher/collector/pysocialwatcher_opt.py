...
class pysocialwatcher_opt(watcherAPI):
            ...
            while data_collection_incomplete:
                try:
                    ...
                    collection_dataframe = pysocialwatcher_opt.perform_collection_data_on_facebook_with_optimization(
                        collection_dataframe, output_dir = "", remove_tmp_files = True)
    ...
    """
    @staticmethod
    def run_data_collection(json_input_file_path, remove_tmp_files = True, output_dir=""):
        ...
        while data_collection_incomplete:
            try:
                ntries = ntries + 1
                collection_dataframe = pysocialwatcher_opt.perform_collection_data_on_facebook_with_optimization(collection_dataframe, output_dir = output_dir, remove_tmp_files = True)
                data_collection_incomplete = False
            except Exception as err:
                if ntries < params.MAX_TRY_ON_FAILED_QUERIES:
                    # still have more tries left; continue after a short wait
