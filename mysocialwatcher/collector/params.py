...
MAX_TRY_ON_FAILED_QUERIES = 1 # max number of tries when the API give errors
SLEEP_TIME_AFTER_API_ERROR = 1 # time in seconds to wait after the API gives an error before retrying
