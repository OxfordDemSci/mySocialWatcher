...
estimate_run_time(specs_dir='./docker/collectors/stitch/gaza_cities/specs', n_tokens=1)

estimate_run_time(specs_dir='./docker/collectors/stitch/westbank_cities/specs', n_tokens=1)
