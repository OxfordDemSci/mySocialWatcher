...
vm = 'badger'
collection = 'dgg_subnational_FB_key_device'
...
if __name__ == '__main__':
    ...
    specs_template_path = os.path.join('config', 'specs', 'examples', 'dgg_subnational_FB_key_device') ## update to dgg_subnational
