...
vm = 'serenity'
collection = 'global_migration_pacific'
...
if __name__ == '__main__':
    ...
    # countries
    countries = [
        "AF", "AM", "AU", "AZ", "BD", "BT", "BN", "KH", "CN", "KP",
        "FJ", "FR", "GE", "IN", "ID", "IR", "JP", "KZ", "KI", "KG",
        "LA", "MY", "MV", "MH", "FM", "MN", "MM", "NR", "NP", "NL",
        "NZ", "PK", "PW", "PG", "PH", "KR", "RU", "WS", "SG", "SB",
        "LK", "TJ", "TH", "TL", "TO", "TR", "TM", "TV", "GB", "US",
        "UZ", "VU", "VN", "AS", "CK", "PF", "GU", "HK", "MO", "NC",
        "NU", "MP"]
    countries.sort()
    ...
    file_out = os.path.join(specs_dir, 'global_migration_pacific.json')
