...
vm = 'stitch'
collection = 'gaza_governorates_homerecent'
...
if __name__ == '__main__':
    ...
    specs_template_path = os.path.join('config', 'specs', 'examples', 'gaza_governorates_homerecent')
    ...
    specs = ['1_facebook_governorates.json', '2_instagram_governorates.json']
    for spec in specs:
