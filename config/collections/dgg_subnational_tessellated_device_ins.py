...
vm = 'badger'
collection = 'dgg_subnational_tessellated_device_ins'
...
if __name__ == '__main__':
    ...
    specs_template_path = os.path.join('config', 'specs', 'examples', 'dgg_subnational_tessellated_device_ins') ## update to dgg_subnational
