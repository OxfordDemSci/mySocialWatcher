...
vm = 'stitch'
collection = 'gaza_municipalities_homerecent'
...
if __name__ == '__main__':
    ...
    specs_template_path = os.path.join('config', 'specs', 'examples', 'gaza_municipalities_homerecent')
    ...
    specs = ['1_facebook_municipalities.json', '2_instagram_municipalities.json']
    for spec in specs:
