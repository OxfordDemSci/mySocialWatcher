...
vm = 'badger'
collection = 'dgg_subnational_fb_key_device_ins'
...
if __name__ == '__main__':
    ...
    specs_template_path = os.path.join('config', 'specs', 'examples', 'dgg_subnational_fb_key_device_ins') ## update to dgg_subnational
